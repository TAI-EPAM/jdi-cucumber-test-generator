...
public class CaseController {
    ...
    @ApiOperation(value = "Get all cases from the suit", nickname = "getCases", position = 1)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = CaseDTO.class, responseContainer = "List"),
            @ApiResponse(code = 404, message = "Suit not found")
    })
    @ApiImplicitParams({
            @ApiImplicitParam(name = "suitId", value = "ID of suit which contains cases", required = true, dataType = "long", paramType = "query")
    })
    ...
    @ApiOperation(value = "Get case by id", nickname = "getCase", position = 2)
    @ApiResponses(value = {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "caseId", value = "ID of case to return", required = true, dataType = "long", paramType = "query")
    })
    ...
    @ApiOperation(value = "Add a new case to the suit", nickname = "addCaseToSuit", position = 3)
    @ApiResponses(value = {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "suitId", value = "ID of suit which will be added a new case", required = true, dataType = "long", paramType = "query"),
    ...
    @ApiOperation(value = "Update case by id", nickname = "updateCase", position = 4)
    @ApiResponses(value = {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "suitId", value = "ID of suit which contains the case", required = true, dataType = "long", paramType = "query"),
            @ApiImplicitParam(name = "caseId", value = "ID of case to update", required = true, dataType = "long", paramType = "query"),
    ...
    @ApiOperation(value = "Delete case by id", nickname = "removeCase", position = 5)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK"),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "suitId", value = "ID of suit which contains the case", required = true, dataType = "long", paramType = "query"),
            @ApiImplicitParam(name = "caseId", value = "ID of case to delete", required = true, dataType = "long", paramType = "query")
    })
    ...
    @ApiOperation(value = "Delete cases from suit", nickname = "removeCases", position = 6)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK"),
            @ApiResponse(code = 404, message = "Suit not found")
    })
