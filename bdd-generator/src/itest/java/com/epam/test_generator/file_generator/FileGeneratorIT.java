...
public class FileGeneratorIT extends Assert {
    @Autowired
    ...
    public void generate_SuitWithCases_Success() throws IOException {
        ...
        File expectedFile = new File("src/itest/resources/FileGeneratorTest1");
    ...
    public void generate_SuitWithCaseWithoutSteps_Success() throws IOException {
        ...
        File expectedFile = new File("src/itest/resources/FileGeneratorTest2");
